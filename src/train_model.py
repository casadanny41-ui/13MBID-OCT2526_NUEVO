...
def train_model(
    ...
    # ---------------------------------------------------------------------------
#++++++++++++++++++++++++++++++++++++++++++++++++++++++ ---------------------------------------------------------------------------
    # EXTRA: Optimización de Hiperparámetros con GridSearchCV
    # ---------------------------------------------------------------------------
    ...
    # Definimos la malla de parámetros para buscar la mejor combinación
    param_grid = {
        'model__C': [0.01, 0.1, 1, 10],
        'model__penalty': ['l1', 'l2']
    }

    # Creamos el pipeline intermedio para la búsqueda
    tmp_pipeline = ImbPipeline([
        ("prep", create_preprocessor(features_X)),
        ("undersample", RandomUnderSampler(random_state=42)),
        ("model", base_model),
    ])

    # Ejecutamos la búsqueda del mejor modelo
    ...
    # Seleccionamos el mejor modelo resultante
